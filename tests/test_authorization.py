...
@pytest.mark.parametrize('email, password', [
    pytest.param('user.name@gmail.com', 'password',
                 id='invalid_email_invalid_password'),
    pytest.param('user.name@gmail.com', '  ',
                 id='invalid_email_empty_password'),
    pytest.param('  ', 'password',
                 id='empty_email_invalid_password'),
])
def test_wrong_email_or_password_authorization(chromium_page: Page, email: str, password: str):
    ...
    # login_button = chromium_page.locator('//button[@data-testid="login-chromium_page-login-button"]')
